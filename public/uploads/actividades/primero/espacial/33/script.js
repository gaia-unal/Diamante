var objetos = [
	{ nombre: 'objeto 1', seleccionado: false },
	{ nombre: 'objeto fuera de', seleccionado: false },
	{ nombre: 'objeto debajo', seleccionado: false },
	{ nombre: 'objeto abajo', seleccionado: false },
];

var valorCorrecto = 1 / (objetos.length);
var puntajes = [valorCorrecto, 0, 0, 0];
