...
window.onload = function(){
	var numeroMinimo = 10003;
	var numeroMaximo = 99997;
	num_base = Math.floor(Math.random() * (numeroMaximo - numeroMinimo + 1)) + numeroMinimo;
	document.getElementById('numero1').textContent = num_base - 1;
	document.getElementById('numero2').textContent = num_base;
	document.getElementById('numero3').textContent = num_base + 1;
}
